...
// 서버 컴퓨터 내에 저장되어있는 파일 경로
 $file_dir = $_SERVER['DOCUMENT_ROOT'].'/freeboard/travel/data/'; 
 ...
 try{
     $sql = "SELECT travel.num, travel.id, travel.nick, travel.subject, travel.content, travel.regist_day, travel.hit, travel.is_html, traveldata.file_name, traveldata.file_copied  FROM freeboard_db.travel INNER JOIN freeboard_db.traveldata ON travel.num = traveldata.num where travel.num = ?";
	...
	$item_content = str_replace(" ", "&nbsp;", $item_content);
     ...
     try{
       ...
       $sql = "update freeboard_db.travel set hit=? where num=?";   // 조회수 증가
       $stmh = $pdo->prepare($sql);  
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div id="col2">
                    <div id="title"><img src="../img/title_travel.png"></div>
                    <div id="view_comment">
                        &nbsp;</div>
                    <div id="view_title">
